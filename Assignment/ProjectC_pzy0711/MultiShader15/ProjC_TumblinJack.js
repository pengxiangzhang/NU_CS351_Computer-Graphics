...
var g_yKeySpin = 0.0;
//------------Camera------------
var g_EyeX = 2.5, g_EyeY = -20.5, g_EyeZ = 30.5;
var g_LookAtX = 2.5, g_LookAtY = -19.5, g_LookatZ = 29.5;
var theta = 90;
...
function toggleBlinn() {
  if (!g_showBlinn) g_showBlinn = true;
  else g_showBlinn = false;
  console.log('g_showBlinn: ' + g_showBlinn);
}
